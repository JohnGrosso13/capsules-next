...
function mergeCounters(friends: number, chats: number, requests: number): Record<Tab, number> {
  return {
    Friends: friends,
    Chats: chats,
    Requests: requests,
...
export function FriendsClient() {
  ...
  const { startChat: startChatSession, unreadCount: chatUnreadCount } = useChatContext();
  ...
  const tabCounters = React.useMemo(
    () => mergeCounters(counters.friends, chatUnreadCount, counters.requests),
    [counters.friends, chatUnreadCount, counters.requests],
  );
