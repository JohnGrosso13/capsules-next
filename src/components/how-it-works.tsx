        ...
        {list.map((step, index) => (
          <div key={step.title} className="flex max-w-[360px] flex-col items-center text-center">
            ...
            <div className="mb-1 flex items-start justify-center gap-2">
              ...
              <h3 className="text-fg mx-auto max-w-[14rem] text-base font-semibold md:text-lg">
                {step.title}
              </h3>
            </div>
            <p className="text-fg-subtle mx-auto max-w-[24rem] text-xs leading-5 md:text-sm md:leading-6">
              {step.desc}
            </p>
          </div>
        ))}
