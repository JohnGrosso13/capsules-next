...
export function BannersCarousel() {
    ...
    return (
      <div className={styles.root}>
        <div className={styles.header}>
          <h3 className={styles.title}>Banners</h3>
        </div>
        <div className={styles.empty}>Sign in to save and recall capsule banners.</div>
      </div>
    );
  }
  ...
  return (
    <div className={styles.root}>
      ...
      {loading ? (
        <div className={styles.empty}>Loading your banners...</div>
      ) : visibleItems.length === 0 ? (
        <div className={styles.empty}>No banners saved yet. Customize a capsule to add one.</div>
      ) : (
