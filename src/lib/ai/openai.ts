      ...
      messages: [
        {
          ...
          content: [
            ...
            "Always preserve explicit event words and occasions (e.g. birthday, wedding, anniversary, graduation, holidays) in the summary or tags.",
            "Keep important numbers and labels (ages, years, dates, version numbers, hashtags) as literal words so they can be searched later.",
            "Prefer to include the main occasion or theme (for example 'birthday posts this year') in both the summary text and tags when present.",
